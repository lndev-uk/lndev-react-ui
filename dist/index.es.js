import React, { cloneElement, createContext, Component, createElement, useState, useReducer, useEffect } from 'react';
...
function Loader(props) {
  ...
  if (loading) {
    if (type === 'bar') {
      return React.createElement('div', { className: 'loadingBar' });
    } else {
      return React.createElement(
        'div',
        { className: 'loadingSpinner' },
        React.createElement('span', { className: 'loadingSpinner-inner' }),
        React.createElement('span', { className: 'loadingSpinner-inner' }),
        React.createElement('span', { className: 'loadingSpinner-inner' }),
        React.createElement('span', { className: 'loadingSpinner-inner' })
      );
...
var StyledComponentsError = function (_Error) {
  ...
  function StyledComponentsError(code) {
    ...
    if (process.env.NODE_ENV === 'production') {
      var _this = possibleConstructorReturn$1(this, _Error.call(this, 'An error occurred. See https://github.com/styled-components/styled-components/blob/master/packages/styled-components/src/utils/errors.md#' + code + ' for more information.' + (interpolations.length > 0 ? ' Additional arguments: ' + interpolations.join(', ') : '')));
    } else {
...
var CloseButton = styled.button(_templateObject);

// onTimeout a function that if defined will use a timer to call the callback
var Notification = React.forwardRef(function Notification(props, ref) {
  ...
  if (isVisible) {
    return React.createElement(
      ...
      dismissal && React.createElement(CloseButton, {
...
function useAnimation(ref, animationName, callback) {
  ...
  var _useState3 = useState(animationName),
...
export { hooks, variables as scss, Loader, Badge, Button, Notification, TextInput };
